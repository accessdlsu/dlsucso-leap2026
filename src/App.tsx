...
import { leapifyApi, type LeapFaq } from "./services/leapify";
import {
  auth,
  db,
  googleProvider,
    ...
    >
      <div
        style={{
          height: "100%",
          width: `${pct * 100}%`,
          background: "linear-gradient(90deg,#de9a49,#fae185,#de9a49)",
...
const TOOLTIPS: Record<string, { label: string; desc: string }> = {
  hut1: {
    label: "Bahay-Kubo",
    desc: "A humble home rooted in community and tradition.",
  },
  hut2: {
    label: "Pavilion",
    desc: "A welcoming space for gathering and learning.",
  },
  palay: {
    label: "Palay",
    desc: "A symbol of harvest, care, and shared growth.",
  },
  salakot: {
    label: "Salakot",
    desc: "A classic Filipino hat for sun and field work.",
  },
  bayong: { label: "Bayong", desc: "A woven bag for everyday market life." },
  pandesal: {
    label: "Pandesal",
    desc: "A warm staple that brings people together.",
  },
};
      ...
      <AnimatePresence>
        {hovered && (
          ...
          >
            ...
            >
              {TOOLTIPS[hovered]?.label}
            </p>
            <p
              style={{
                fontFamily: "'DM Sans',sans-serif",
                fontSize: 11,
                color: "rgba(249,236,182,0.52)",
                margin: 0,
                marginTop: 2,
              }}
            >
              {TOOLTIPS[hovered]?.desc}
            </p>
          </motion.div>
        )}
      </AnimatePresence>
      ...
      >
        <defs>
          ...
          <linearGradient id="hill3G" x1="0%" y1="0%" x2="0%" y2="100%">
            <stop offset="0%" stopColor="#193825" />
            <stop offset="100%" stopColor="#0f2018" />
          </linearGradient>
          <linearGradient id="hill2G" x1="0%" y1="0%" x2="0%" y2="100%">
            <stop offset="0%" stopColor="#1e4a2c" />
            <stop offset="100%" stopColor="#12271a" />
          </linearGradient>
          <linearGradient id="hill1G" x1="0%" y1="0%" x2="0%" y2="100%">
            <stop offset="0%" stopColor="#245630" />
            <stop offset="100%" stopColor="#152e1c" />
          </linearGradient>
          <linearGradient id="groundG" x1="0%" y1="0%" x2="0%" y2="100%">
            <stop offset="0%" stopColor="#2a6234" />
            <stop offset="100%" stopColor="#1a3a20" />
          </linearGradient>
          <linearGradient id="fadeG" x1="0%" y1="0%" x2="0%" y2="100%">
            <stop offset="0%" stopColor="#0e1a0c" stopOpacity="0" />
            <stop offset="100%" stopColor="#f9ecb6" stopOpacity="1" />
          </linearGradient>
          <linearGradient id="roofG" x1="0%" y1="0%" x2="0%" y2="100%">
            <stop offset="0%" stopColor="#c8a46e" />
            <stop offset="100%" stopColor="#9e7844" />
          </linearGradient>
          <linearGradient id="roofG2" x1="0%" y1="0%" x2="0%" y2="100%">
            <stop offset="0%" stopColor="#b89460" />
            <stop offset="100%" stopColor="#8e6838" />
          </linearGradient>
          <linearGradient id="wallG" x1="0%" y1="0%" x2="100%" y2="0%">
            <stop offset="0%" stopColor="#c49a72" />
            <stop offset="60%" stopColor="#b8875e" />
            <stop offset="100%" stopColor="#a07040" />
          </linearGradient>
          <linearGradient id="wallG2" x1="0%" y1="0%" x2="100%" y2="0%">
            <stop offset="0%" stopColor="#d4aa82" />
            <stop offset="60%" stopColor="#c49870" />
            <stop offset="100%" stopColor="#b08050" />
          </linearGradient>
          <radialGradient id="summitGlow" cx="50%" cy="10%" r="40%">
            <stop offset="0%" stopColor="#de9a49" stopOpacity="0.2" />
            <stop offset="100%" stopColor="#de9a49" stopOpacity="0" />
          </radialGradient>
          <linearGradient id="mistG" x1="0%" y1="0%" x2="0%" y2="100%">
            <stop offset="0%" stopColor="#4ab09a" stopOpacity="0.07" />
            <stop offset="100%" stopColor="#4ab09a" stopOpacity="0" />
          </linearGradient>
          ...
          <radialGradient id="hutGlowG" cx="50%" cy="50%" r="50%">
            <stop offset="0%" stopColor="#fae185" stopOpacity="0.2" />
            <stop offset="100%" stopColor="#fae185" stopOpacity="0" />
          </radialGradient>
          <linearGradient id="waterG" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#4ab09a" stopOpacity="0.1" />
            <stop offset="50%" stopColor="#7dd4c4" stopOpacity="0.18" />
            <stop offset="100%" stopColor="#4ab09a" stopOpacity="0.07" />
          </linearGradient>
        ...
        {[
          ...
          <circle
            ...
            fill="#fae185"
            opacity="0.2"
            className={`star-twinkle star-d${i % 5}`}
          />
        ))}
        ...
        {[
          ...
          <g
            key={i}
            className={`bird bird-d${i}`}
            style={{
              transform: `translate(calc(${x}px + var(--px, 0) * -4px), calc(${y}px + var(--py, 0) * -2px)) scale(${sc})`,
              animationDelay: `${dl}s`,
            }}
          >
            <path
              d="M0 0 Q6 -5 12 0 Q18 -5 24 0"
              fill="none"
              stroke="rgba(222,154,73,0.4)"
              strokeWidth="2"
              strokeLinecap="round"
            />
          </g>
        ...
        >
          ...
          <path
            d="M900 18 L882 58 L894 54 L900 30 L906 54 L918 58 Z"
            fill="rgba(240,235,215,0.2)"
          />
          <ellipse
            cx="900"
            cy="22"
            rx="14"
            ry="9"
            fill="rgba(222,154,73,0.22)"
            className="volcano-pulse"
          />
        </g>
        ...
        >
          <path
            d="M0 250 Q150 195 310 220 Q430 238 550 215 Q620 200 710 290 L0 290 Z"
            fill="url(#hill3G)"
          />
          <path
            d="M1090 290 Q1170 210 1280 200 Q1360 192 1440 220 L1440 290 Z"
            fill="url(#hill3G)"
          />
        </g>
        ...
        <g
          style={{
            transform:
              "translate(calc(var(--px, 0) * -5px), calc(var(--py, 0) * -3px))",
          }}
        >
          <path
            d="M0 295 Q130 255 280 272 Q430 290 560 258 Q680 228 800 265 Q920 302 1060 260 Q1180 225 1310 262 Q1390 282 1440 270 L1440 480 L0 480 Z"
            fill="url(#hill3G)"
          />
        </g>
        <g
        ...
        >
          <path
            d="M0 278 Q360 260 720 275 Q1080 290 1440 272 L1440 310 Q1080 328 720 312 Q360 296 0 314 Z"
            fill="url(#mistG)"
          />
          <path
            d="M0 294 Q360 279 720 291 Q1080 303 1440 293 L1440 326 Q1080 326 720 314 Q360 302 0 314 Z"
            fill="url(#waterG)"
          />
        </g>
        <g
        ...
        >
          <path
            d="M0 318 Q110 285 250 302 Q400 320 540 290 Q660 264 780 295 Q910 328 1060 290 Q1180 260 1310 290 Q1390 308 1440 298 L1440 480 L0 480 Z"
            fill="url(#hill2G)"
          />
        </g>
        <g
          style={{
            transform:
              "translate(calc(var(--px, 0) * -1.5px), calc(var(--py, 0) * -1px))",
          }}
        >
          <path
            d="M0 352 Q130 322 300 338 Q460 355 620 325 Q760 298 900 332 Q1050 368 1200 335 Q1330 308 1440 330 L1440 480 L0 480 Z"
            fill="url(#hill1G)"
          />
        </g>

        <path
          d="M0 388 Q360 374 720 382 Q1080 390 1440 380 L1440 480 L0 480 Z"
          fill="url(#groundG)"
        />
        <rect
          x="0"
        ...
        />
        {[
          40, 100, 160, 220, 310, 400, 500, 580, 660, 750, 840, 940, 1040, 1140,
          1240, 1320, 1380,
        ].map((x, i) => (
          <g key={i} transform={`translate(${x}, 408)`}>
            <path
              d={`M0 0 Q-3 -8 -1 -14 Q1 -8 0 0`}
              fill="#2a6a30"
              opacity="0.6"
            />
            <path
              d={`M0 0 Q3 -6 5 -11 Q4 -6 0 0`}
              fill="#2a6a30"
              opacity="0.5"
            />
          </g>
        ...
        <g
          style={{
            transform:
              "translate(calc(36px + var(--px, 0) * 7px), calc(226px + var(--py, 0) * 4px))",
          }}
        >
          <path
            d="M0 190 Q3 152 -2 115 Q-5 86 0 56 Q4 26 2 0"
            stroke="#7a5a30"
            strokeWidth="9"
            fill="none"
            strokeLinecap="round"
          ...
          {[
            ...
            return (
              <path
                key={i}
                d={`M2 0 Q${2 + (Math.cos(r) * (len as number)) / 2} ${(Math.sin(r) * (len as number)) / 2} ${2 + Math.cos(r) * (len as number)} ${Math.sin(r) * (len as number)}`}
                stroke="#1a6030"
                strokeWidth="3.5"
                fill="none"
                strokeLinecap="round"
                className={`palm-sway palm-d${i % 4}`}
              />
            );
          })}
        ...
        <g
          style={{
            transform:
              "translate(calc(1398px + var(--px, 0) * 9px), calc(238px + var(--py, 0) * 4px))",
          }}
        >
          <path
            d="M0 178 Q-3 143 2 106 Q5 80 0 52 Q-4 24 -2 0"
            stroke="#7a5a30"
            strokeWidth="8"
            fill="none"
            strokeLinecap="round"
          ...
          {[-150, -120, -90, -60, -30, 0, 30].map((angle, i) => {
            ...
            return (
              <path
                key={i}
                d={`M-2 0 Q${-2 + (Math.cos(r) * len) / 2} ${(Math.sin(r) * len) / 2} ${-2 + Math.cos(r) * len} ${Math.sin(r) * len}`}
                stroke="#1a6030"
                strokeWidth="3"
                fill="none"
                strokeLinecap="round"
        ...
        <g
          style={{
            transform:
              "translate(calc(108px + var(--px, 0) * 5px), calc(230px + var(--py, 0) * 3px))",
            cursor: "pointer",
            pointerEvents: "all",
          }}
        ...
        >
          ...
          />
          <path
            d="M148 50 Q152 40 148 30 Q145 22 150 14"
            fill="none"
            stroke="rgba(200,190,170,0.12)"
            strokeWidth="4.5"
            strokeLinecap="round"
        ...
        <g
          style={{
            transform:
              "translate(calc(980px + var(--px, 0) * 3px), calc(255px + var(--py, 0) * 2px))",
            cursor: "pointer",
            pointerEvents: "all",
          }}
        ...
        >
          ...
          <ellipse
            ...
            fill="#ffcc44"
            opacity="0.06"
            className="window-flicker window-flicker-d1"
          />
        ...
        <g
          style={{
            transform:
              "translate(calc(610px + var(--px, 0) * 2px), calc(270px + var(--py, 0) * 1.5px))",
            cursor: "pointer",
            pointerEvents: "all",
          }}
        ...
        >
          ...
          <g
            className="palay-stalk sway-a"
            style={{ animationDelay: "0s", transformOrigin: "30px 150px" }}
          >
            <path
              d="M30 150 Q28 110 22 70 Q20 50 18 30"
              stroke="#4a7a20"
              strokeWidth="2.5"
              fill="none"
              strokeLinecap="round"
            ...
            {[4, 8, 12, 16, 20, 24].map((y, i) => (
              <ellipse
                ...
                ry="7"
                fill="url(#palayG)"
                transform={`rotate(${-20 + (i % 2) * 40},${5 + (i % 2 === 0 ? -3 : 3)},${y})`}
              />
            ))}
            <path
              d="M22 70 Q5 60 -8 55"
          ...
          <g
            className="palay-stalk sway-b"
            style={{ animationDelay: "0.4s", transformOrigin: "60px 150px" }}
          >
            <path
              d="M60 150 Q58 112 55 72 Q53 52 50 32"
              stroke="#4a7a20"
              strokeWidth="2.5"
              fill="none"
              strokeLinecap="round"
            />
            <path
              d="M50 32 Q44 22 40 14 Q38 10 36 5"
              stroke="#5a8a25"
              strokeWidth="2"
              fill="none"
              strokeLinecap="round"
            />
            {[5, 9, 13, 17, 21, 25].map((y, i) => (
              <ellipse
                key={i}
                cx={36 + (i % 2 === 0 ? -3 : 3)}
                cy={y}
                ...
                ry="7"
                fill="url(#palayG)"
                transform={`rotate(${-18 + (i % 2) * 36},${36 + (i % 2 === 0 ? -3 : 3)},${y})`}
              />
            ))}
            <path
              d="M53 75 Q38 65 25 62"
              stroke="#5a9020"
              strokeWidth="2"
              fill="none"
            />
            <path
              d="M55 95 Q70 85 80 82"
              stroke="#5a9020"
              strokeWidth="2"
              fill="none"
            />
          ...
          <g
            className="palay-stalk sway-a"
            style={{ animationDelay: "0.2s", transformOrigin: "95px 150px" }}
          >
            <path
              d="M95 150 Q93 108 90 65 Q88 45 86 22"
              stroke="#4a7a20"
              strokeWidth="2.5"
              fill="none"
              strokeLinecap="round"
            />
            <path
              d="M86 22 Q80 12 76 4 Q74 0 72 -4"
              stroke="#5a8a25"
              strokeWidth="2"
              fill="none"
              strokeLinecap="round"
            />
            {[-4, 0, 4, 8, 12, 16, 20].map((y, i) => (
              <ellipse
                key={i}
                cx={72 + (i % 2 === 0 ? -4 : 4)}
                cy={y}
                ...
                ry="7.5"
                fill="url(#palayG)"
                transform={`rotate(${-22 + (i % 2) * 44},${72 + (i % 2 === 0 ? -4 : 4)},${y})`}
              />
            ))}
            <path
              d="M88 68 Q72 58 58 54"
              stroke="#5a9020"
              strokeWidth="2"
              fill="none"
            />
            <path
              d="M90 90 Q106 80 118 76"
              stroke="#5a9020"
              strokeWidth="2"
              fill="none"
            />
          ...
          <g
            className="palay-stalk sway-b"
            style={{ animationDelay: "0.6s", transformOrigin: "128px 150px" }}
          >
            <path
              d="M128 150 Q126 113 123 73 Q121 53 118 33"
              stroke="#4a7a20"
              strokeWidth="2.5"
              fill="none"
              strokeLinecap="round"
            />
            <path
              d="M118 33 Q112 23 108 15 Q106 11 104 6"
              stroke="#5a8a25"
              strokeWidth="2"
              fill="none"
              strokeLinecap="round"
            ...
            {[6, 10, 14, 18, 22, 26].map((y, i) => (
              <ellipse
                ...
                ry="7"
                fill="url(#palayG)"
                transform={`rotate(${-20 + (i % 2) * 40},${104 + (i % 2 === 0 ? -3 : 3)},${y})`}
              />
            ))}
            <path
              d="M121 76 Q107 65 92 62"
              stroke="#5a9020"
              strokeWidth="2"
              fill="none"
            />
            <path
              d="M124 98 Q138 88 150 84"
              stroke="#5a9020"
              strokeWidth="2"
              fill="none"
            />
          ...
          <g
            className="palay-stalk sway-a"
            style={{ animationDelay: "0.8s", transformOrigin: "158px 150px" }}
          >
            <path
              d="M158 150 Q156 115 154 78 Q152 58 150 38"
              stroke="#4a7a20"
              strokeWidth="2.5"
              fill="none"
              strokeLinecap="round"
            />
            <path
              d="M150 38 Q144 28 140 20 Q138 16 136 11"
              stroke="#5a8a25"
              strokeWidth="2"
              fill="none"
              strokeLinecap="round"
            />
            {[11, 15, 19, 23, 27, 31].map((y, i) => (
              <ellipse
                key={i}
                cx={136 + (i % 2 === 0 ? -3 : 3)}
                cy={y}
                ...
                ry="6.5"
                fill="url(#palayG)"
                transform={`rotate(${-18 + (i % 2) * 36},${136 + (i % 2 === 0 ? -3 : 3)},${y})`}
              />
            ))}
            <path
              d="M152 80 Q138 70 124 67"
              stroke="#5a9020"
              strokeWidth="2"
              fill="none"
            />
            <path
              d="M154 100 Q168 90 178 87"
              stroke="#5a9020"
              strokeWidth="2"
              fill="none"
            />
        ...
        <g
          style={{
            transform:
              "translate(calc(1218px + var(--px, 0) * 4px), calc(315px + var(--py, 0) * 2px))",
            cursor: "pointer",
            pointerEvents: "all",
          }}
        ...
        >
          ...
          <path
            d="M0 0 L-85 85 Q-90 95 -80 100 Q0 108 80 100 Q90 95 85 85 Z"
            fill="url(#salakotG)"
          />
          <path
            d="M0 0 L85 85 Q90 95 80 100 Q40 105 0 105 Z"
            fill="rgba(0,0,0,0.15)"
          />
          {[25, 45, 65, 85].map((y, i) => {
            const w = 22 + i * 16;
          ...
          {[-70, -45, -20, 0, 20, 45, 70].map((ang, i) => (
            <line
              ...
              x1="0"
              y1="0"
              x2={Math.sin((ang * Math.PI) / 180) * 90}
              y2={95}
              stroke="rgba(100,60,10,0.2)"
              strokeWidth="1.2"
            />
          ))}
        ...
        <g
          style={{
            transform:
              "translate(calc(1340px + var(--px, 0) * 5px), calc(348px + var(--py, 0) * 3px))",
            cursor: "pointer",
            pointerEvents: "all",
          }}
        ...
        >
          ...
          <path
            d="M10 8 Q4 4 2 0 Q0 -4 4 -8 Q10 -10 16 -8 Q22 -4 20 0 Q18 4 12 8 Z"
            fill="#de9a49"
          />
          <path
            d="M14 8 Q18 4 22 0 Q24 -4 28 -8 Q32 -10 36 -8 Q42 -4 40 0 Q38 4 32 8 Z"
            fill="#de9a49"
          />
          ...
          <path
            d="M16 8 Q18 -12 26 -20 Q34 -28 40 -28 Q46 -28 54 -20 Q62 -12 64 8"
            fill="none"
            stroke="#c07020"
            strokeWidth="5"
            strokeLinecap="round"
        ...
        <g
          style={{
            transform:
              "translate(calc(408px + var(--px, 0) * 3px), calc(352px + var(--py, 0) * 2px))",
            cursor: "pointer",
            pointerEvents: "all",
          }}
        ...
        {Array.from({ length: 32 }).map((_, i) => (
          <g
            key={i}
            transform={`translate(${i * 46 + 8}, 418)`}
            className={`palay-border palay-border-d${i % 5}`}
          >
            <line
              x1="6"
              y1="42"
            ...
            <ellipse
              ...
              fill="#de9a49"
              opacity="0.12"
              transform={`rotate(${-12 + (i % 3) * 10},${4 + (i % 2 === 0 ? -2 : 2)},9)`}
            />
          </g>
        ))}
      </svg>
...
const SubthemesStrip = ({
  ...
  <div
    className={compact ? styles.subthemesCompactShell : styles.subthemesSection}
  >
    <div
    ...
    >
      <span
        className={
          compact ? styles.subthemesCompactLabel : styles.subthemesLabel
        }
      >
        Subthemes
      </span>
      {compact ? (
        <div className={`${styles.subthemesRow} ${styles.subthemesRowCompact}`}>
          ...
          >
            <span className={styles.subthemeAssetIcon}>
              <Sparkles size={20} />
            </span>
        ...
        <div className={styles.subthemesRow}>
          <button
            ...
            onClick={() => onSelect(null)}
          >
            <span className={styles.subthemePillIcon}>
              <Sparkles size={20} />
            </span>
...
const GlowRing = () => (
  <div
    style={{
      ...
      borderRadius: 31,
      background:
        "conic-gradient(from 0deg, #fae185, #de9a49, #c07830, #de9a49, #fae185)",
...
const MainEventsSection = ({
  ...
  useEffect(() => {
    const fetchMainEvents = async () => {
      try {
        ...
        const spotlightEvents = allEvents
          .filter((e) => e.isSpotlight || e.status === "published")
          .slice(0, 5);

        if (spotlightEvents.length > 0) {
          const eventList = spotlightEvents.map((ev) => {
            let formattedDate = ev.dateTime || "";
            let formattedTime = ev.startTime
              ? `${ev.startTime}${ev.endTime ? ` - ${ev.endTime}` : ""}`
              : "";

            // Deduplicate if dateTime already has the time
            if (formattedDate.includes(":") && formattedTime) {
              formattedTime = "";
            }

            if (
              ev.dateTime &&
              !ev.dateTime.includes(" - ") &&
              !ev.dateTime.includes(":")
            ) {
              const startObj = new Date(ev.dateTime);
              if (!isNaN(startObj.getTime())) {
                formattedDate = startObj.toLocaleDateString("en-US", {
                  month: "long",
                  day: "numeric",
                  year: "numeric",
                });
                if (!ev.startTime) {
                  formattedTime = startObj.toLocaleTimeString("en-US", {
                    hour: "numeric",
                    minute: "2-digit",
                  });
                }
            ...
            return {
              ...
              image:
                ...
                "https://placehold.co/812x510?text=No+Image+Found",
              ...
              venue: ev.venue || "",
              slots: ev.maxSlots || 0,
              subtheme: ev.theme?.name || "",
              orgLogo: ev.organization?.logoUrl || null,
              googleFormUrl: ev.gformsUrl || "",
  ...
  const goTo = (idx: number) => {
    ...
    autoRef.current = setInterval(
      () => setActiveIndex((c) => (c + 1) % events.length),
      4500,
    );
  };
          ...
          {visibleIndexes.map((eventIndex, slot) => {
            ...
            return (
              <motion.div
                ...
                style={{
                  width: isCenter
                    ? "clamp(310px, 43vw, 800px)"
                    : "clamp(200px, 28vw, 560px)",
                  height: isCenter
                    ? "clamp(250px, 34vw, 440px)"
                    : "clamp(190px, 26vw, 360px)",
                  borderRadius: 28,
                  overflow: "hidden",
                  border: isCenter
                    ? "1.5px solid rgba(249,236,182,0.52)"
                    : "1px solid rgba(249,236,182,0.15)",
                  background: "#0a1408",
                  position: "relative",
                  flexShrink: 0,
                  marginLeft:
                    ...
                    >
                        ...
                        {event.orgLogo ? (
                          <img
                            ...
                            style={{
                              ...
                              borderRadius: 8,
                              objectFit: "cover",
                              border: "2px solid rgba(222,154,73,0.65)",
                              boxShadow: "0 0 12px rgba(222,154,73,0.3)",
                            }}
                            referrerPolicy="no-referrer"
                          />
                        ) : (
                          <div
                            style={{
                              ...
                              height: 30,
                              borderRadius: 8,
                              background: "rgba(222,154,73,0.22)",
                              ...
                              fontWeight: 800,
                              color: "#de9a49",
                              boxShadow: "0 0 10px rgba(222,154,73,0.25)",
                            }}
                          >
                        ...
                        {event.subtheme && (
                          <motion.span
                            ...
                            style={{
                              ...
                              background: "rgba(51,75,70,0.78)",
                              color: "#fae185",
                              padding: "0.22rem 0.65rem",
                              borderRadius: 5,
                              backdropFilter: "blur(10px)",
                              border: "1px solid rgba(250,225,133,0.22)",
                            }}
                          >
                            {event.subtheme}
                          </motion.span>
                      ...
                      <motion.div
                        ...
                        style={{
                          ...
                          borderRadius: 5,
                          backdropFilter: "blur(10px)",
                          border: "1px solid rgba(250,225,133,0.15)",
                          boxShadow: "0 0 12px rgba(250,225,133,0.15)",
                        }}
                      >
                        {event.slots} SLOTS
                      </motion.div>
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <Calendar
                            size={10}
                            style={{ color: "#fae185", flexShrink: 0 }}
                          />
                          <span>
                            {event.date}
                      ...
                      >
                        <a
                          ...
                          style={{
                            background:
                              "linear-gradient(135deg,#fae185,#de9a49,#c07830)",
                            color: "#1a1008",
                            border: "none",
                            borderRadius: 8,
                            ...
                            textDecoration: "none",
                            cursor: "pointer",
                            boxShadow: "0 4px 16px rgba(222,154,73,0.45)",
                        ...
                        <button
                          ...
                          style={{
                            ...
                            border: "1px solid rgba(250,225,133,0.45)",
                            color: "#fae185",
                            borderRadius: 8,
                            padding: "0.5rem 1.1rem",
                            fontSize: "0.63rem",
          ...
          >
            <button
              ...
              style={{
                ...
                height: 38,
                borderRadius: "50%",
                border: "1px solid rgba(249,236,182,0.28)",
                  ...
                  <span
                    style={{
                      ...
                      background:
                        index === activeIndex
                          ? "#fae185"
                          : "rgba(249,236,182,0.32)",
                      transition: "all 0.32s ease",
                      boxShadow:
                        index === activeIndex
                          ? "0 0 12px rgba(250,225,133,0.7)"
                          : "none",
                    }}
                  />
                </button>
...
const LeapApp = () => {
  ...
  const [faqs, setFaqs] = useState<LeapFaq[]>([]);
  const [loading, setLoading] = useState(true);
  const [isAdminView, setIsAdminView] = useState(false);
  const [currentView, setCurrentView] = useState<
    "home" | "about" | "major-events" | "classes" | "faq" | "contact"
  >("home");
  ...
  const [sortBy, setSortBy] = useState<
    "title-asc" | "title-desc" | "slots-desc" | "slots-asc"
  >("title-asc");
  ...
  const navigateTo = (
    view: "home" | "about" | "major-events" | "classes" | "faq" | "contact",
  ) => {
    setCurrentView(view);
    setIsMenuOpen(false);
  ...
  const filteredAndSortedClasses: LeapClass[] = useMemo(() => {
    ...
    if (currentView === "home" && activeSubtheme) {
      result = result.filter((c) =>
        c.subtheme.toLowerCase().includes(activeSubtheme.toLowerCase()),
      );
    }
    result.sort((a, b) => {
  ...
  const uniqueDays: string[] = useMemo(
    () =>
      Array.from(new Set(filteredAndSortedClasses.map((c) => c.date))).sort(
        ...
        try {
          ...
          if (currentUser) {
            ...
            if (
              ...
              !currentEmail?.endsWith("@dlsu.edu.ph")
            ) {
              setUserProfile(null);
            ...
            try {
              ...
              if (isPermissionDenied) {
                if (!hasLoggedProfilePermissionIssue.current) {
                  console.warn("Firestore profile access denied.");
  ...
  useEffect(() => {
    const fetchFaqs = async () => {
      try {
        ...
        setFaqs(data.sort((a, b) => a.sortOrder - b.sortOrder));
      } catch (error) {
        console.error("Leapify API Error (FAQs):", error);
      }
    };
    fetchFaqs();
  }, []);
  ...
  useEffect(() => {
    ...
    const fetchClasses = async () => {
      try {
        const allEvents = await leapifyApi.getEvents();
        console.log("[App] allEvents received:", allEvents);
        const classList: LeapClass[] = allEvents.map((ev) => {
          let formattedDate = ev.dateTime || "";
          let formattedTime = ev.startTime
            ? `${ev.startTime}${ev.endTime ? ` - ${ev.endTime}` : ""}`
            : "";

          // If the date string already contains time-like info (e.g. "21:07"),
          // clear the separate time string to avoid "May 21 21:07 · 21:07"
          if (formattedDate.includes(":") && formattedTime) {
            formattedTime = "";
          }

          // Try to parse for a nicer format ONLY if it's not already a complex range string
          if (
            ev.dateTime &&
            !ev.dateTime.includes(" - ") &&
            !ev.dateTime.includes(":")
    ...
    let intervalId: ReturnType<typeof setInterval> | null = null;
    const startPolling = () => {
      if (!intervalId) intervalId = setInterval(fetchClasses, 60000);
    };
    const stopPolling = () => {
      if (intervalId) {
        clearInterval(intervalId);
  ...
  const handleSignIn = async () => {
    ...
    try {
      ...
      if (!result.user.emailVerified || !email?.endsWith("@dlsu.edu.ph")) {
        await signOut(auth);
        setAuthError(
          "Access Denied: Please use your verified official @dlsu.edu.ph email to sign in.",
        );
      }
    } catch (error: any) {
      ...
      <div className={styles.cardImageWrapper}>
        ...
        <div className={styles.cardOverlayContent}>
          <div className={styles.cardOverlayTopRow}>
            ...
            {item.subtheme && (
              <span className={`${styles.cardBadge} ${styles.cardBadgeTheme}`}>
                {item.subtheme}
              </span>
            )}
          </div>
  ...
  const AdminDashboard = () => (
    <div className={styles.adminWrapper}>
      ...
      <div className={styles.adminCard}>
        <div className={styles.adminIconWrap} style={{ width: 80, height: 80 }}>
          <Edit size={36} />
        </div>
        <h3
          className={styles.adminCardTitle}
          style={{ fontFamily: "'Playfair Display', serif" }}
        >
          Classes are managed in Leapify
        </h3>
        <p className={styles.adminCardDesc}>
          To add, edit, or delete classes, please use the Leapify administration
          console.
        </p>
        <div
          className={styles.adminCTABtn}
          style={{
    ...
    >
      <div style={{ maxWidth: 880, margin: "0 auto" }}>
        ...
        >
          ...
          >
            Reach out for registration help, class concerns, or general
            questions.
          </p>
          <div
            style={{
          ...
          >
            ...
            >
              ...
              >
                ...
                <h3
                  style={{ margin: 0, fontSize: "0.95rem", color: "#334b46" }}
                >
                  Email
                </h3>
              </div>
            ...
            >
              ...
              <p style={{ margin: 0, color: "#567069" }}>
                Within 1-2 business days
              </p>
            </div>
          </div>
          <a
            href="mailto:leap@dlsu.edu.ph"
      ...
      <div style={{ background: "transparent", padding: "0" }}>
        ...
        <div
          style={{
            width: "100%",
            background:
              "linear-gradient(180deg, #0e1a0c 0%, #132015 35%, #1a2e1e 65%, #2a3d22 85%, #fffdf6 100%)",
            paddingBottom: "1px",
          }}
        >
          <div
          ...
          >
            ...
            <div
              style={{
                ...
                height: 80,
                background:
                  "radial-gradient(ellipse 80% 100% at 50% 100%, rgba(222,154,73,0.18) 0%, transparent 70%)",
                pointerEvents: "none",
                zIndex: 1,
              }}
            />
            ...
            >
              ...
              <path
                d="M0,20 C180,50 360,10 540,30 C720,50 900,15 1080,35 C1260,55 1380,25 1440,38 L1440,90 L0,90 Z"
                fill="#132015"
                opacity="0.7"
              />
              ...
              {[
                40, 110, 190, 270, 340, 420, 510, 590, 670, 760, 840, 920, 1010,
                1090, 1180, 1260, 1340, 1410,
              ].map((x, i) => {
                const h = 28 + (i % 4) * 6;
                const lean = ((i % 3) - 1) * 4;
                ...
                return (
                  <g
                    key={i}
                    transform={`translate(${x}, ${55 - h})`}
                    opacity="0.55"
                  >
                    <path
                      d={`M0,${h} Q${lean},${h / 2} ${lean * 0.6},0`}
                      stroke="url(#stemGrad)"
                      strokeWidth="1.5"
                      fill="none"
                      strokeLinecap="round"
              ...
              {/* Mid wave */}
              <path
                d="M0,35 C200,15 400,55 600,35 C800,15 1000,50 1200,30 C1320,18 1400,40 1440,45 L1440,90 L0,90 Z"
                fill="#1d2e1a"
                opacity="0.5"
              />
              ...
              <path
                d="M0,48 C160,28 320,62 520,45 C720,28 880,58 1080,42 C1240,30 1360,52 1440,56 L1440,90 L0,90 Z"
                fill="url(#waveGrad1)"
              />

              {/* Gold shimmer line along crest */}
              <path
                d="M0,48 C160,28 320,62 520,45 C720,28 880,58 1080,42 C1240,30 1360,52 1440,56"
                stroke="rgba(222,154,73,0.28)"
                strokeWidth="1"
                fill="none"
              />
  ...
  if (!hasAppAccess) {
    return (
      <div className={styles.appContainer}>
        ...
        <nav
          className={`fixed top-0 w-full z-50 transition-all duration-300 bg-transparent py-5`}
        >
  ...
  return (
    <div className={styles.appContainer}>
      ...
      >
        <div className={styles.navInner}>
          ...
          <div className={styles.navCenter}>
            ...
            <button
              onClick={() => navigateTo("major-events")}
              className={`nav-link ${currentView === "major-events" ? "active" : ""}`}
            >
              Featured
            </button>
            <button
              onClick={() => navigateTo("classes")}
              className={`nav-link ${currentView === "classes" ? "active" : ""}`}
            >
              Classes
            </button>
            <button
          ...
          <div className={styles.navMobileToggle}>
            <button
              ...
              style={{
                color:
                  currentView === "home" && !scrolled ? "#f9ecb6" : "#334b46",
              }}
            ...
            <div className={styles.mobileMenuContent}>
              ...
              {userProfile?.role === "admin" && (
                <button
                  ...
                  className={`${styles.mobileMenuItem} ${styles.adminLink}`}
                >
                  Admin Dashboard
                </button>
              )}
              {user ? (
                <button
                  onClick={handleSignOut}
                  className={styles.mobileMenuSignOutBtn}
                >
                ...
                <button
                  onClick={handleSignIn}
                  className={styles.mobileMenuSignInBtn}
                >
      ...
      >
        ...
        {currentView === "faq" && <FAQs faqs={faqs} />}
        ...
        <div className={styles.footerContainer}>
          <div className={styles.footerBrand}>
            ...
            <p className={styles.footerBrandText}>
              Lasallian Enrichment Alternative Program. Empowering students
              through diverse learning experiences and community building.
            </p>
