      ...
      <main className="container mx-auto px-4 pb-24 max-w-5xl">
        ...
        <div className="vm-grid">
          {[
            ...
            <m.div key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.12 }} className="vm-card">
        ...
        <div className="values-section">
          ...
          <div className="values-grid">
            {values.map((v, i) => (
              <m.div key={i} initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }} className="value-card">
        ...
        <m.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="theme-banner">
