...
export default function Home({
  ...
  const panelStyle = {
    background:
      "linear-gradient(145deg, rgba(255,252,241,0.98), rgba(253,247,228,0.96))",
    backdropFilter: "blur(12px)",
    borderRadius: 20,
    border: "1px solid rgba(222,154,73,0.24)",
    boxShadow:
      "0 2px 0 rgba(222,154,73,0.12), 0 18px 42px rgba(51,75,70,0.1), inset 0 1px 0 rgba(255,255,255,0.9)",
  } as const;
  ...
  const accentLine = (
    <div
      style={{
        ...
        background:
          "linear-gradient(90deg, transparent, rgba(222,154,73,0.5), transparent)",
      }}
    />
  );
        ...
        >
          <div
            style={{
              ...
              inset: 0,
              background:
                "radial-gradient(ellipse 80% 60% at 50% 15%, rgba(222,154,73,0.18) 0%, transparent 70%)",
              pointerEvents: "none",
            }}
          />
          {HeroSection}
        ...
        >
          ...
          <div
            style={{
              ...
              height: 3,
              background:
                "linear-gradient(90deg, transparent 0%, rgba(222,154,73,0.4) 20%, rgba(250,225,133,0.7) 50%, rgba(222,154,73,0.4) 80%, transparent 100%)",
            }}
          />
            ...
            >
              ...
              <aside
                ...
                style={{
                  ...
                  maxHeight: isDesktop
                    ? `calc(100vh - ${daysStickyTop + 20}px)`
                    : "none",
                      ...
                      return (
                        <button
                          ...
                          style={{
                            ...
                            borderRadius: 10,
                            border: isActive
                              ? "1px solid rgba(250,225,133,0.5)"
                              : "1px solid rgba(222,154,73,0.18)",
                            background: isActive
                              ? "linear-gradient(145deg, rgba(222,154,73,0.18), rgba(250,225,133,0.14))"
                              : "rgba(255,255,255,0.6)",
                            cursor: "pointer",
                            transition: "all 0.2s",
                            boxShadow: isActive
                              ? "0 4px 14px rgba(222,154,73,0.2)"
                              : "none",
                            minHeight: 52,
                      ...
                      return (
                        <button
                          ...
                          style={{
                            ...
                            border: isActive
                              ? "1px solid rgba(250,225,133,0.5)"
                              : "1px solid rgba(222,154,73,0.12)",
                            background: isActive
                              ? "linear-gradient(145deg, rgba(222,154,73,0.18), rgba(250,225,133,0.14))"
                              : "rgba(255,255,255,0.6)",
                            cursor: "pointer",
                            ...
                            position: "relative",
                            boxShadow: isActive
                              ? "0 8px 22px rgba(222,154,73,0.22), inset 0 1px 0 rgba(255,255,255,0.6)"
                              : "0 1px 4px rgba(51,75,70,0.06)",
                            width: "100%",
                          }}
                        >
                          {isActive && (
                            <div
                              style={{
                                ...
                                borderRadius: 99,
                                background:
                                  "linear-gradient(180deg,#fae185,#de9a49)",
                              }}
                            />
                          )}
                          <span
                          ...
                          <span
                            style={{
                              ...
                              fontSize: "0.68rem",
                              fontWeight: 600,
                              color: isActive ? "#de9a49" : "#7c6b4b",
                            }}
                          >
                            {
                              filteredAndSortedClasses.filter(
                                (c) => c.date === day,
                              ).length
                            }{" "}
                            classes
              ...
              >
                {!user ? (
                  ...
                  displayedDays.map((day, idx) => {
                    const dayClasses = filteredAndSortedClasses.filter(
                      (c) => c.date === day,
                    );
                    ...
                    const visibleClasses = isExpanded
                      ? dayClasses
                      : dayClasses.slice(0, CLASSES_PER_DAY);
                        ...
                        >
                          ...
                          <div
                            style={{
                              ...
                              boxShadow: "0 2px 8px rgba(222,154,73,0.15)",
                              whiteSpace: "nowrap",
                            }}
                          >
                            {dayClasses.length}{" "}
                              ...
                              >
                                <button
                                  ...
                                  style={{
                                    ...
                                    boxShadow:
                                      "0 2px 12px rgba(222,154,73,0.18)",
                                  }}
                                >
                                  {isExpanded ? (
                                    <>
          ...
          createPortal(
            <div
              ...
              style={{
                ...
                padding: isMobile ? 0 : "clamp(0.5rem, 2vw, 1.5rem)",
                overflow: "hidden",
                display: "grid",
                placeItems: "center",
              }}
            >
              <div
                ...
                style={{
                  width: isMobile ? "100vw" : "min(1040px, 96vw)",
                  maxHeight: isMobile ? "100dvh" : "calc(100dvh - 2rem)",
                  height: isMobile ? "100dvh" : "auto",
                  background:
                    "linear-gradient(180deg, #fffdf6 0%, #f9f1da 100%)",
                  borderRadius: isMobile ? 0 : 18,
                  overflow: "auto",
                  border: isMobile ? "none" : "1px solid rgba(222,154,73,0.3)",
                  boxShadow: isMobile
                    ? "none"
                    : "0 24px 64px rgba(51,75,70,0.18)",
                  position: "relative",
                  margin: 0,
                }}
              >
                ...
                >
                  <div
                    style={{
                      position: "relative",
                      minHeight: w >= 640 ? 300 : 200,
                      maxHeight: w >= 640 ? "calc(100dvh - 2rem)" : 240,
                      overflow: "hidden",
                    }}
                  >
                    <img
                      ...
                      {viewingClass.orgLogo && (
                        <img
                          ...
                          style={{
                            ...
                            borderRadius: 8,
                            objectFit: "cover",
                            border: "2px solid rgba(222,154,73,0.6)",
                          }}
                          referrerPolicy="no-referrer"
                        />
                      )}
                  ...
                  >
                    ...
                    >
                      {[
                        ...
                        },
                        {
                          icon: <Users size={18} />,
                          label: "Slots",
                          value: `${viewingClass.slots} participants`,
                        },
                      ].map((item, i) => (
                        <div
                          key={i}
                    ...
                    <div
                      style={{
                        borderTop: "1px solid rgba(222,154,73,0.22)",
                        paddingTop: "1rem",
                      }}
                    >
                      <h3
